<x-admin-app-layout :title="'Team Management'">
    <div
                ...
                class="app-container container-fluid py-10 pt-0"
              >
                <!-- Main Content Start -->
                <div class="row">
                  <div class="col-xl-12">
                    <div class="card h-md-100">
                      <div
                        class="card-header position-relative py-0 border-bottom-1 ps-0"
                      >
                        <ul
                          class="nav nav-stretch nav-pills nav-pills-custom d-flex mt-4"
                        >
                          <li class="nav-item p-0 ms-0">
                            <a
                              class="nav-link btn btn-color-gray-500 flex-center px-3 active"
                              data-bs-toggle="tab"
                              href="#allEmploye"
                            >
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td class="text-center">
                                      <a
                                        href="#"
                                        class="btn btn-primary btn-sm px-3 pe-2 me-3"
                                      >
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td class="text-center">
                                      ...
                                      <a
                                        href="#"
                                        class="btn btn-danger btn-sm px-3 pe-2"
                                      >
                                        <i class="fa-solid fa-trash"></i>
                                      </a>
                                    </td>
