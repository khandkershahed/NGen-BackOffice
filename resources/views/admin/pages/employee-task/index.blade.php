<x-admin-app-layout :title="'Employee Task'">
    ...
    <div class="card card-flash">
        <div class="card-header mt-6">
            ...
            <div class="card-toolbar">
                ...
                <a href="{{ route('admin.employee-task.create') }}" class="btn btn-light-primary">
                ...
                <tbody class="fw-bold text-gray-600">
                    ...
                    @foreach ($items as $key => $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.employee-task.edit', $item->id) }}" class="text-primary">
                                    <i class="fa-solid fa-pencil text-primary"></i>
                                </a>

                                <a href="{{ route('admin.employee-task.destroy', $item->id) }}" class="delete">
        ...
        <script>
            $(document).ready(function() {
                $('.status-toggle').change(function() {
                    ...
                    $.ajax({
                        url: '/admin/employee-task/status/' + statusId,
                        method: 'PUT',
                        data: {
                            _token: '{{ csrf_token() }}',
                            status: newStatus
